...
void loop() {
    ...
    if (voie3 < 1500) { // mode Manuel
        ...
        if ((AverageD == 0 || AverageD >= 30) && (AverageG == 0 || AverageG >= 30) && (AverageF == 0 || AverageF >= 30)) {
            cmd_motor(0, 1, 70);
            cmd_motor(1, 1, 70);
        }  else if ((AverageD == 0 || AverageD >= 30) && (AverageG == 0 || AverageG >= 30) && (AverageF == 0 || AverageF < 30)) {
            cmd_motor(0, 1, 45);
            cmd_motor(1, 1, 45);
        } else if (AverageF <= 30) {
            if (AverageF > 15) {
        ...
        else if ((AverageD < 30) && (AverageG >= 30 || AverageG == 0)) {
            cmd_motor(0, 1, 30);
            cmd_motor(1, 1, 40);
        } else if ((AverageG < 30) && (AverageD >= 30 || AverageD == 0)) {
            cmd_motor(0, 1, 40);
            cmd_motor(1, 1, 30);
        } else {
            //cmd_motor(0, 1, 0);
